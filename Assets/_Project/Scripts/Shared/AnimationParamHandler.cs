...
public class AnimationParamHandler : MonoBehaviour
{
    ...
    public void SetDirectionAndSetMoving(Vector2 direction, float threshold)   // Qui faccio un overload di SetDirectionAndSetMoving, aggiungendo un threshold,
    {                                                                          // in modo da evitare che piccoli movimenti causino l'animazione di movimento

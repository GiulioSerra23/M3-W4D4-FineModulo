...
public class NpcController : Creature
{
    ...
    private void Move()
    {
        ...
        _animHandler.SetDirectionAndSetMoving(velocity, 0.05f);  // Qui uso l'overload con un threshold per evitare piccoli movimenti che causano l'animazione di movimento
    }

    private void FixedUpdate()
    {
        if (!_playerInTrigger && _target == null) return;
